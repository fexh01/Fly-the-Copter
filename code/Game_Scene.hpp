...
#define GAME_SCENE_HEADER
    ...
    namespace example
    {
        ...
        private:
            ...
            Sprite_List obstacles;

            bool           flying;

            Timer          timer;                               ///< Cronómetro usado para medir intervalos de tiempo

            std::shared_ptr < Texture_2D > CopterLogo_texture;
            std::shared_ptr < Texture_2D > BackButton_texture;
            std::shared_ptr < Texture_2D > StopButton_texture;
            std::shared_ptr < Texture_2D > Continue_texture;
